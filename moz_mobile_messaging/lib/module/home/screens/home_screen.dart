...
import '../../contacts/screens/contact_list_page.dart';
...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  void setUserNameAndNameIfNull() {
    ...
    if (username == null || fullName == null) {
      _firestore.collection(Paths.usersPath).doc(uid).get().then((doc) {
        SharedObjects.prefs.setString(Constants.sessionUsername, doc.get('username'));
        SharedObjects.prefs.setString(Constants.fullName, doc.get('name'));
              ...
              children: <Widget>[
                Row(
                  children: [
                    ...
                    //           //         .profilePicUrl),
                    //           //backgroundImage: NetworkImage('https://upload.wikimedia.org/wikipedia/commons/0/0a/Gnome-stock_person.svg'),
                    //         ),
                    //       ),
                    //     ),
                    //   ),
                ...
                Expanded(
                    ...
                    child: BlocBuilder<HomeBloc, HomeState>(
                      builder: (context, state) {
                        ...
                        if (conversations.length > 0 && conversations.isNotEmpty) {
