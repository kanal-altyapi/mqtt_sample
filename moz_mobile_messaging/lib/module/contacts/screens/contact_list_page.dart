...
import '../blocks/contacts/contacts_bloc.dart';
import '../widgets/contact_row_widget.dart';
...
class _ContactListPageState extends State<ContactListPage>
 ...
 late ContactsBloc contactsBloc;
  ...
  Color stuffColor = Colors.blueGrey.shade700;
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar:AppBar(title: Text('Select Contact'),),// _selectedIndex == 0 ? _buildNormalAppBar(screenWidth) : null,
